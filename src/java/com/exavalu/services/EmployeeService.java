...
public class EmployeeService {
    ...
    public ArrayList getAllEmployees()
    {
        ...
        String sql = "SELECT * FROM employeedb.employees JOIN departments ON employees.departmentId =departments.departmentId join roles on employees.roleId = roles.roleId;";
     ...
     public ArrayList doSearchEmployee(Employee emp) {
        ...
        try {
            Connection con = JDBCConnectionManager.getConnection();
            String sql = "select * from employees e, departments d, roles r where e.departmentId=d.departmentId and e.roleId=r.roleId having firstName like ? and lastName like ? and gender like ? and departmentName like ? and roleName like ? AND isDeleted=0;";
...
//            System.out.println("size of rs="+ rs.getFetchSize());
     ...
     public boolean doCreateEmployee(Employee emp) {
        ...
        try {
            Connection con = JDBCConnectionManager.getConnection();
            String sql = "INSERT INTO employees (firstName,lastName,phoneNumber,address,gender,age,departmentId,roleId,basicSalary,carAllowance) VALUES (? ,? ,? ,?,?,?,?,?,?,? )";
            PreparedStatement preparedStatement = con.prepareStatement(sql);
